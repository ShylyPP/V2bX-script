...
install_V2bX() {
    ...
    if  [ $# == 0 ] ;then
        ...
        last_version=$1
        url="https://github.com/ShylyPP/V2bX-Private/releases/download/${last_version}/V2bX-linux-${arch}.zip"
        echo -e "开始安装 V2bX $1"
...
EOF
    ...
    curl -o /usr/bin/V2bX -Ls https://raw.githubusercontent.com/ShylyPP/V2bX-Private/master/V2bX.sh
